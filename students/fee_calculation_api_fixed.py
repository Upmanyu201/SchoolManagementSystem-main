    ...
    try:
        ...
        try:
            ...
            for payment in payments:
                ...
                if hasattr(payment, 'fees_type') and payment.fees_type:
                    fee_type = f"{payment.fees_type.group_type}"
                elif "Fine Payment" in (getattr(payment, 'note', '') or ""):
                    fee_type = "Fine Payment"
                elif "Carry Forward" in (getattr(payment, 'note', '') or ""):
